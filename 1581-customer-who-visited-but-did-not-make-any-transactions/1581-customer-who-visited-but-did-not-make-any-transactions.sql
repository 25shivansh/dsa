...
select v.Customer_id,count(*) as count_no_trans from Visits as v where not exists(select 1 from transactions as t where t.visit_id =v.visit_id)group by v.customer_id